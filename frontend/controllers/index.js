import TypingTest from "/frontend/models/TypingTest.js";
import Timer from "/frontend/models/Timer.js";
import ResultHistory from "/frontend/models/ResultHistory.js";
...
function fetchWords(fileName = "english_200", onReady) {
  let url = `http://127.0.0.1:5500/frontend/assets/json/${fileName}.json`;
...
// function fetchWords(fileName = "bahasa_indonesia_200", onReady) {
//   let url = `http://127.0.0.1:5500/assets/json/bahasa_indonesia_200.json`;
